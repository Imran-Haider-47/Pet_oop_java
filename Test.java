		...
		case(1):   // If user enter 1 then the code in case 1 will run
		{
			...
			switch(option) // Again switch statement to prompt the user to select the option of his desire
			{
				case(1):
					...
					{
						case('a'):
							int b1=-1; // variable to check the condtion of do-while loop
							do {
							...
							d.Dec_Hygiene();// calls the function from pet class and increase the hygiene by 1						
							d.Dec_Energy();//// calls the function from pet class and increase the Energy by 1
						...
						do {
							...
							if(temp2==1) 
							{                        // Description of all these is given in above 
								a2=1;
								b2=temp2;
							}
							if(temp2==2)
				...
				case(2):
					...
					if(temp1==2)   // Description given above
					{
						a4=-1;
						a1=2;
					}
