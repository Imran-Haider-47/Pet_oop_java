...
public class Pet 
{
	...
	int Hunger_Index;// We will traverse these arrays with their corresponding variables to access their indices
	private String[] Hygiene= {"Needs Shower","Smelly","Clean"};// Attributes array of the pet
	int Hygiene_Index;// We will traverse these arrays with their corresponding variables to access their indices
	private String[] Energy= {"Sleepy","Drowzy","Restless","Awake","Energized"};// Attributes array of the pet
	int Energy_Index;// We will traverse these arrays with their corresponding variables to access their indices
	private String[] Mood= {"Depressed","Unhappy","Content","Happy","Cheerful","Joyful"};// Attributes array of the pet
	int Mood_Index;// We will traverse these arrays with their corresponding variables to access their indices
